...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
		  	<li class="active dropdown">
		  		...
		  		<ul class="dropdown-menu">
			      	<li class="active"><a data-toggle="tab" href="#106th">碩二 106 th</a></li>
			      	<li><a data-toggle="tab" href="#107th">碩一 107 th</a></li>
			    </ul>
			</li>
		  	<li class="dropdown">
		...
		<div class="tab-content">
			<?php
				$n_ths=array("107th","106th","105th","104th","103th","in_service","phd");
				foreach ($n_ths as $n_th)
				{
					if ($n_th == "106th" || $n_th == "107th")
